...
### 🎨 감성 & 무드
- **🌈 6가지 테마 색상**: 핑크(기본), 블루, 오렌지, 그린, 퍼플
- **✨ Pretendard 폰트**: 세련된 한글 타이포그래피
...
- **🔒 집중 모드**: 방해 없이 할 일에 집중
- **⏰ 할 일 나이 표시**: 오래된 할 일을 시각적으로 강조 (실시간 갱신)
- **📅 내일로 미룸**: 오늘 못할 일은 내일로 미루기
...
│   ├── practicality-manager.js # 실용성 기능 (미룬 시간, 내일로 미룸)
│   ├── swipe-gestures.js    # 스와이프 제스처
│   ├── confetti-manager.js  # Confetti 애니메이션
...
- 📅 "내일로 미룸" 기능 추가
- ⏰ 미룬 시간 실시간 갱신 (1분마다)
- 🎯 헤더 UI/UX 개선 (그라디언트 텍스트, 유리 질감 뱃지)
- 🔧 CI 워크플로우 개선
